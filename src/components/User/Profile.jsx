...
//mui
import { TextField, Button, MenuItem, InputLabel, Select, Box, Typography } from '@mui/material'
        ...
        <>
            ...
            {userInfo?.joinAs == 'mentor' ?
                <div>
                    ...
                    {userInfo?.joinAs == 'mentor' ? <MyScheduleClass profileId={userId} /> : null}
                </div> : <></>}
